const csdown = {
    ...
    aes: $.toString(() => {
        ...
        if (!getMyVar('host', '')) {
            let appurl = fetch('https://nfile.upfile.live/uploads/20250729/291a085186411253e2c008d2263eaa8c.txt');
                ...
                d.push({
                    ...
                    url: $().lazyRule((url, parse_api_url, token, from) => {
                        ...
                        if (from == 'ATQP1') {
                            ...
                            return m3u8
                        } else if (url.includes('.m3u8') || from == 'GBDmp4' || from == 'GNKM') {
